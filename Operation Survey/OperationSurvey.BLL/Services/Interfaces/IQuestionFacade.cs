...
namespace OperationSurvey.BLL.Services.Interfaces
{
    ...
    { 
        ...
        PagedResultsDto GetAllQuestionsByUserId(int page, int pageSize, int userId, int tenantId, long departmentId, long categoryIdFilter, long catgoryTypeId, string pageName);
