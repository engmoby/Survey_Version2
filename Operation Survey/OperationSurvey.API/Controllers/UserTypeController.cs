...
namespace OperationSurvey.API.Controllers
{
    public class UserTypeController : BaseApiController
    {
        ...
        {
            PagedResultsDto userTypeObj = _userTypeFacade.GetAllUserTypes(page, pagesize, TenantId);
        ...
        {
            var reurnUserType = _userTypeFacade.CreateUserType(Mapper.Map<UserTypeDto>(userTypeModel), UserId, TenantId);
        ...
        {
            var reurnUserType = _userTypeFacade.EditUserType(Mapper.Map<UserTypeDto>(userTypeModel), UserId, TenantId);
        ...
        {
            var reurnUserType = _userTypeFacade.GetUserType(userTypeId, TenantId);
            return Ok(reurnUserType);
        }
    }
